  ...
  return (
    <div className="relative flex w-full lg:w-96">
      <input
        type="text"
        placeholder="Поиск..."
        className="w-full px-4 py-2 text-sm lg:text-base rounded-lg border border-neutral-50 bg-transparent focus:outline-none focus:ring-2 focus:ring-neutral-400"
        value={searchTerm}
