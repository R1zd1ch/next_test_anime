    ...
    <footer className="bg-neutral-950 text-white py-10 px-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-400">
              AnimeXD - это ваш источник для всего, что связано с аниме. Смотрите последние выпуски,
              читайте новости и изучайте жанры.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 mt-10 pt-5 text-center">
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} AnimeXD. Все права защищены.
          </p>
        </div>
      </div>
    </footer>
